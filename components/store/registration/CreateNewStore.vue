  ...
  <v-container fluid>
    <v-col cols="12" class="body-2">
      ...
      <v-stepper v-model="stepper">
        <v-stepper-header>
          <v-stepper-step step="1" :complete="stepper > 1">Location Details</v-stepper-step>
          <v-divider></v-divider>
          <v-stepper-step step="2" :complete="stepper > 2">Personal Details</v-stepper-step>
        </v-stepper-header>
